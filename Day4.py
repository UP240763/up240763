...
Cod = "Codificación"
pa = "Para"     #Defenir variables
to = "Todos"
Cadena2 = Cod + space + pa + space + to
print(Cadena2)

# 3: Declarar una variable llamada empresa y asignarle un valor inicial
empresa = "Codificación para todos"

# 4: Imprimir la variable empresa
print(empresa)

# 5: Imprimir la longitud de la cadena
print(len(empresa))
