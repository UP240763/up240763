...
#5. Separe los primeros tres elementos y los últimos tres elementos de la lista food_staff_lt
...
#7. Comprobar si un elemento existe en la lista (ya que la tupla fue eliminada)
print("pera" in food_staff_lt)
print("chocolate" in food_staff_lt)

#8. Comprueba si 'Estonia' es un país nórdico
países_nórdicos = ('Dinamarca', 'Finlandia', 'Islandia', 'Noruega', 'Suecia')
print('Estonia' in países_nórdicos)

#9. Comprueba si 'Islandia' es un país nórdico
